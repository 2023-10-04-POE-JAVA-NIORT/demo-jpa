...
public class AddressDAO {
    ...
    public static List<Person> findAll(){
        Query findAllQuery = entityManager.createQuery("SELECT a FROM Address a");
    ...
    public static void deleteById_v2(Long id){
        tx.begin();
        Query deleteQuery = entityManager.createQuery("DELETE FROM Address p WHERE p.id= :id");
    ...
    // UPDATE
    public static void update(Long id, Address a){

        Address fromDatabase = findById(id);
